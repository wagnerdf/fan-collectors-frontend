...
function RecuperarSenha() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-800 via-gray-900 to-black text-white flex items-center justify-center px-4">
      <div
        className={`bg-gray-900 p-8 rounded-2xl shadow-lg w-full max-w-md border border-gray-700 transition-all duration-500 ${
          showForm || mensagem ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'
        }`}
      >
